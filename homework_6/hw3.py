...
positionOne = Position('Vilma', 'Schneider', 0, 7, 7)

print(f"name: {positionOne.name}")
print(f"surname: {positionOne.surname}")
print(f"position: {positionOne.position}")

print(f"full name: {positionOne.get_full_name()}")
print(f"total income: {positionOne.get_total_income()}")
